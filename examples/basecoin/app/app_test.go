...
func TestMsgs(t *testing.T) {
	...
	for i, m := range msgs {
		// Run a CheckDeliver
		SignCheckDeliver(t, bapp, m.msg, []int64{0}, []int64{int64(i)}, false, priv1)
	}
}
...
func TestMsgChangePubKey(t *testing.T) {
	...
	SignCheckDeliver(t, bapp, changePubKeyMsg, []int64{0}, []int64{1}, true, priv1)
	acc = bapp.accountMapper.GetAccount(ctxDeliver, addr1)
	...
	SignCheckDeliver(t, bapp, sendMsg1, []int64{0}, []int64{2}, true, priv2)
...
func TestMsgSendWithAccounts(t *testing.T) {
	...
	SignCheckDeliver(t, bapp, sendMsg1, []int64{0}, []int64{1}, true, priv1)
}
...
func TestMsgSendDependent(t *testing.T) {
	...
	// Simulate a Block
	SignCheckDeliver(t, bapp, sendMsg4, []int64{1}, []int64{0}, true, priv2)
...
func TestIBCMsgs(t *testing.T) {
	...
	SignCheckDeliver(t, bapp, transferMsg, []int64{0}, []int64{1}, false, priv1)
	SignCheckDeliver(t, bapp, receiveMsg, []int64{0}, []int64{2}, true, priv1)
	CheckBalance(t, bapp, addr1, "10foocoin")
	SignCheckDeliver(t, bapp, receiveMsg, []int64{0}, []int64{3}, false, priv1)
}
...
func SignCheckDeliver(t *testing.T, bapp *BasecoinApp, msg sdk.Msg, accnums []int64, seq []int64, expPass bool, priv ...crypto.PrivKeyEd25519) {
